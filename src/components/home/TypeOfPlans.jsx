    ...
    <div className="container marketing mt-5 p-3" style={borderStyle}>
        <div className="row featurette">
            ...
            <img className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500"
                height="500" src="assets/familia-viajando.jpg" aria-label="Placeholder: 500x500"
      ...
      <div className="row featurette">
        ...
        <div className="col-md-5 order-md-1">
          <img className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500"
            height="500" src="assets/home-e-mulher-viajando.jpg"  aria-label="Placeholder: 500x500"
            preserveAspectRatio="xMidYMid slice" focusable="false">
          </img>
      ...
      <div className="row featurette">
        ...
        <div className="col-md-5">
          <img className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500"
            height="500" src="assets/grupo-amigos.jpg" aria-label="Placeholder: 500x500"
            preserveAspectRatio="xMidYMid slice" focusable="false">
        </img>
