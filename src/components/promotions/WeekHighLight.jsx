        ...
        return(
            <section>
                <div className="card bg-dark text-white m-5">
                  <img src="bonito-mato-grosso-do-sul.jpg" height="400px" className="card-img featured_img"
                  ...
                  <div className="card-img-overlay text-center" style={{backgroundColor: "rgba(0, 0, 0, .3)"}}>
                    ...
                    <p className="card-text fs-2 fw-semibold w-100">Bonito - Mato Grosso do sul.</p>
                    <p className="text-decoration-line-through text-inline w-100">De R$ 2.750,00</p>
                    <p className="m-2" style={inlineMiddleStyle}>Por R$ 1.990,00</p>
